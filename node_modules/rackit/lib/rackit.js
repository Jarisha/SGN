...
Rackit.prototype.init = function (cb) {
	...
	setInterval(function() {
      ...
      console.log('Reauthentication happened');
		});
	}, 23 * oneHour);
};
...
Rackit.prototype._authenticate = function (cb) {
  ...
  console.log('authenticate');
	...
	request(options, function (err, res, body) {
      ...
      console.log('authenticate error: '+res.statusCode);
...
/**
 * Reauthenticates. Really just a wrapper that lets us access the _authenticate func
 * 
 */
Rackit.prototype.reAuth = function(cb){
  var o1 = this;
  o1._authenticate(function(err){
