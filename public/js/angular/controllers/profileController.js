var ProfileController = ['$scope', '$rootScope', '$http', '$location', '$timeout', 'resolveProfile', 'gamepinService',
  function($scope, $rootScope, $http, $location, $timeout, resolveProfile, gamepinService){
...
ProfileController.resolve = {
  resolveProfile: ['$q', '$rootScope', '$location', '$http', '$timeout',
    function($q, $rootScope, $location, $http, $timeout){
