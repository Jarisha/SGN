...
exports.like = function(req, res){
	...
	async.waterfall([
		...
		function(callback){
			...
			else errlog.info('You already liked this post') //return callback(new Error('Already liked this post'));
			base.save_RO(RO_user, 'users', function(err, saved){
				...
				else errlog.info('Post already liked by you'); //callback(new Error('Post already liked by you'));
